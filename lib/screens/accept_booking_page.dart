import 'package:drone/screens/onboarding_thirteen_tab_container_screen.dart';
        ...
        child: Scaffold(
          body: Column(
            children: [
              ...
              InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>OnboardingThirteenTabContainerScreen()));
                },
                child: Container(
                  width: 327.0,
                  height: 48.0,
